...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		The functions for non-blocking communication are \texttt{MPI
		\_Irecv(<response buffer pointer>, <size of the data>,<data type>, <process rank>, <message tag>, MPI\_COMM\_WORLD, <wait\_for buffer pointer>)}
